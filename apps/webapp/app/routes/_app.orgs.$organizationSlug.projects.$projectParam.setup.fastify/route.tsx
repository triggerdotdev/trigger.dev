...
export default function SetUpFastify() {
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div>
          ...
          <div>
            <StepNumber
              stepNumber="1"
              title="Follow the steps from the Fastify manual installation guide"
            />
            <StepContentContainer className="flex flex-col gap-2">
              ...
              <LinkButton
                to="https://trigger.dev/docs/documentation/guides/manual/fastify"
            ...
            <StepNumber stepNumber="2" title="Run your Fastify app" />
            <StepContentContainer>
              <RunDevCommand />
            </StepContentContainer>
