...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  // Drop only the global-only forbidden flags (not the broad org-locked set), so every other org
  // override in the body is persisted untouched.
