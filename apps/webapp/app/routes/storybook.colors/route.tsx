  ...
  return (
    ...
    >
      ...
      <StorySection
        ...
        description="Same pill, same size, same weight — the tint and the text color are the only variables. Under the preference the tinted ones gain a contrast-chip ring, which rises with the interface-contrast setting; the ones that fill solid skip it, since a ring drawn in the label colour is just a hairline inset into the fill."
      >
        <Audit
