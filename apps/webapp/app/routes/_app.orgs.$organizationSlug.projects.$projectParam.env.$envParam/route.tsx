...
export default function Page() {
  const { hasDashboardAgentAccess, dashboardAgentDemo } = useLoaderData<typeof loader>();
  return (
    <DashboardAgent hasAccess={hasDashboardAgentAccess} demoEnabled={dashboardAgentDemo}>
      <Outlet />
    </DashboardAgent>
  );
}
