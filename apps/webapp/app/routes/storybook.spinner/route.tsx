...
export default function Story() {
  return (
    <div className="flex flex-col items-start gap-y-3 p-4">
      <div className="flex items-center gap-x-4 rounded-md bg-background-hover px-3 py-2 text-text-bright">
        Blue: <Spinner color="blue" />
      </div>
      <div className="flex items-center gap-x-4 rounded-md bg-background-hover px-3 py-2 text-text-bright">
        White: <Spinner color="white" />
      </div>
      <div className="flex items-center gap-x-4 rounded-md bg-surface-control px-3 py-2 text-text-bright">
