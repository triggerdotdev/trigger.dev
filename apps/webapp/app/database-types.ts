...
function isTaskRunAttemptStatus(value: string): value is keyof typeof TaskRunAttemptStatus {
  return Object.values(TaskRunAttemptStatus).includes(value as keyof typeof TaskRunAttemptStatus);
}

function isTaskRunStatus(value: string): value is keyof typeof TaskRunStatus {
