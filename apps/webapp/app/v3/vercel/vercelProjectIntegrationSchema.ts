...
/**
 * Drops env slugs the project has no environment for. Only touches keys present on the input, so a
 * partial config update never clobbers a field the caller didn't mean to change.
 */
