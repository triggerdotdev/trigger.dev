  ...
  return (
    <div className="mt-4">
      ...
      <Paragraph spacing className="mb-4">
        To get started we recommend search for an official Node SDK for {api.name}, you can then use
        their API documentation to get started and create tasks.
      </Paragraph>
      ...
      {api.examples && api.examples.length > 0 ? (
        ...
        <>
          <Header3 className="mb-2">We're happy to help</Header3>
          <Paragraph spacing className="mb-4">
            Please{" "}
            <Feedback
              button={
              ...
              defaultValue="help"
            />{" "}
            if you're having any issues connecting your API, we'll help you get set up as quickly as
            possible.
          </Paragraph>
