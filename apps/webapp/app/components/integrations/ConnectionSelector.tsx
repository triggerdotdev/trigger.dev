        ...
        {({ open }) => (
          <>
            <Popover.Button
              className={`
          ${open ? "" : ""}
          inline-flex justify-between items-center rounded text-white bg-slate-700 shadow pl-3 pr-2 py-1.5 gap-2 text-sm hover:bg-slate-700/50 transition focus:outline-none`}
            >
