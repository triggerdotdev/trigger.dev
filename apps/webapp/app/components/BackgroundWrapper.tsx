...
export function BackgroundWrapper({ children }: { children: ReactNode }) {
  return (
    <div className="relative h-full w-full overflow-hidden bg-background-dimmed lg:bg-transparent light:lg:bg-background-dimmed">
      <div
        className="absolute left-0 top-0 hidden w-[260px] bg-contain bg-top-left bg-no-repeat lg:block light:lg:hidden"
        style={{
      ...
      <div
        className="absolute bottom-0 left-0 hidden w-[260px] bg-contain bg-bottom-left bg-no-repeat lg:block light:lg:hidden"
        style={{
      ...
      <div
        className="absolute top-0 hidden bg-top-left bg-no-repeat lg:block light:lg:hidden"
        style={{
          left: "260px",
