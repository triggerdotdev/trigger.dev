...
const variants = {
  ...
  button: {
    button:
      "w-fit py-2 pl-3 pr-4 rounded border border-border-bright/50 shadow-xs bg-background-bright hover:bg-background-hover transition hover:data-[state=checked]:bg-surface-selected-hover data-[state=checked]:bg-surface-selected data-disabled:opacity-70",
    label: "text-text-bright select-none",
    description: "text-text-dimmed",
    inputPosition: "mt-1",
    icon: "w-8 h-8 mb-2",
  ...
  description: {
    button:
      "w-full p-2.5 rounded-md border border-border-bright/50 shadow-xs bg-background-bright transition hover:bg-background-hover data-disabled:opacity-70 hover:data-[state=checked]:bg-surface-selected-hover data-[state=checked]:bg-surface-selected",
  ...
  icon: {
    button:
      "w-full p-2.5 pb-4 rounded-sm border border-border-bright/50 shadow-xs bg-background-bright hover:bg-background-hover transition data-disabled:opacity-70 hover:data-[state=checked]:bg-surface-selected-hover data-[state=checked]:bg-surface-selected",
