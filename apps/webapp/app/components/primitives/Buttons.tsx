...
const variant = {
  "primary/small": {
    ...
    button:
      "h-6 px-[5px] text-xs bg-indigo-600 hover:bg-indigo-500/90 disabled:opacity-50",
    icon: "h-3.5",
    shortcut:
  ...
  "secondary/small": {
    ...
    button:
      "h-6 px-[5px] text-xs bg-slate-800 hover:bg-slate-700/70 disabled:opacity-50",
    icon: "h-3.5",
    shortcut:
  ...
  "tertiary/small": {
    textColor: "text-dimmed group-hover:text-bright transition",
    button:
      "h-6 px-[5px] text-xs bg-transparent hover:bg-slate-850 disabled:opacity-50",
    icon: "h-3.5",
    shortcut:
  ...
  "danger/small": {
    textColor: "text-bright group-hover:text-white transition",
    button:
      "h-6 px-[5px] text-xs bg-rose-600 hover:bg-rose-500 disabled:opacity-50",
    icon: "h-3.5",
    shortcut:
      "text-xxs font-medium py-0.25 min-w-[14px] rounded-[2px] px-0.5 ml-1 border border-bright/40 text-bright group-hover:border-bright/60 transition",
  },
