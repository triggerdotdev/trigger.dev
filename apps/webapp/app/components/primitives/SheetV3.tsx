...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}
    <SheetPrimitive.Close className="flex items-center gap-1 rounded-sm p-1 pl-0 transition hover:bg-hover focus-visible:focus-custom disabled:pointer-events-none">
