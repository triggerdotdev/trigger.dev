...
const panelVariantStyle = {
  ...
  slate:
    "flex w-full items-center justify-between gap-2 truncate rounded bg-slate-850/50 py-2 pl-2.5 pr-1 transition hover:cursor-pointer hover:bg-slate-800 hover:text-slate-400",
