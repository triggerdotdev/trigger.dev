...
export const CreateDatabasePropertiesSchema: JSONSchema = {
  type: "object",
...
export const CreateDatabaseBodyParametersSchema: JSONSchema = {
  type: "object",
  properties: {
    parent: {
      type: "object",
    ...
    properties: CreateDatabasePropertiesSchema,
    icon: {
      anyOf: [
        {
          type: "object",
...
export const CreateDatabaseParametersSchema: JSONSchema =
  CreateDatabaseBodyParametersSchema;

export const CreateDatabaseResponseSchema: JSONSchema = {
