...
export const spec: IntegrationSchema = {
  definitions: {
      ...
      properties: {
        personalizations: {
          ...
          items: {
            ...
            properties: {
              from: {
                $ref: "#/definitions/from_email_object_schema",
              },
              to: {
    ...
    marketing_contacts_request_body: {
      type: "object",
      properties: {
        list_ids: {
          type: "array",
        ...
        contacts: {
          ...
          maxItems: 30000,
          items: {
            $ref: "#/definitions/contact_request",
          },
        },
      },
      required: ["contacts"],
    },
    marketing_contacts_response_body: {
      type: "object",
      properties: {
        job_id: {
          type: "string",
    ...
    error_response_body: makeObjectSchema("Error", {
      requiredProperties: {
