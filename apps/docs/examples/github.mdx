...
Trigger.dev SDK & GitHub packages for a new project:

```bash
npm install @trigger.dev/sdk @trigger.dev/github zod
```
GitHub packages for an existing project:
...
```bash
pnpm install @trigger.dev/sdk @trigger.dev/github zod
```
GitHub packages for an existing project:
```bash
pnpm install @trigger.dev/github
```
...
```bash
yarn add @trigger.dev/sdk @trigger.dev/github zod
```
GitHub packages for an existing project:
