...
<Expandable title="items" defaultOpen={false}><ParamField path="records[n]" type="object" required={false}>
   Record
...
*Please note that this object is one of the following possible types*
<Expandable title="possible types for response" defaultOpen={false}><ResponseField path="Multiplerecordscreatedresponse" type="object" required={false}>
