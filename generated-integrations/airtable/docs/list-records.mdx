...
<Expandable title="properties"><ParamField path="baseId" type="string" required={true}>
   ...
   Sort
<Expandable title="items"><ParamField path="sort[n]" type="object" required={false}>
   Sort field
<Expandable title="properties"><ParamField path="field" type="string" required={true}>
   Field name
...
<Expandable title="items"><ParamField path="fields[n]" type="string" required={false}>
   Field name
