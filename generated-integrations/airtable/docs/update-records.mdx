...
<Expandable title="properties"><ParamField path="records" type="array" required={true}>
   Records to update/upsert
<Expandable title="items"><ParamField path="records[n]" type="object" required={true}>
   Record
...
<Expandable title="properties"><ParamField path="url" type="string" required={true}>
   ...
   Thumbnail Height
</ParamField></Expandable></ParamField></Expandable></ParamField></Expandable></ParamField></Expandable></ParamField></Expandable></ParamField></Expandable></ParamField><ParamField path="id" type="string" required={false}>
   Record ID. Required when performUpsert is not set.
</ParamField></Expandable></ParamField></Expandable></ParamField><ParamField path="baseId" type="string" required={true}>
   The ID of the base
</ParamField><ParamField path="tableIdOrName" type="string" required={true}>
   The name or id of the table
</ParamField><ParamField path="performUpsert" type="object" required={false}>
   Perform upsert
<Expandable title="properties"><ParamField path="fieldsToMergeOn" type="array" required={true}>
   Fields to merge on
<Expandable title="items"><ParamField path="fieldsToMergeOn[n]" type="string" required={true}>
   Field name
</ParamField></Expandable></ParamField></Expandable></ParamField><ParamField path="typecast" type="boolean" required={false}>
...
<ResponseField path="response" type="object" required={true}>
   Update Records Output

*Please note that this object is one of the following possible types*
<Expandable title="possible types for response"><ResponseField path="Updateresponse" type="object" required={false}>
   Update response
...
<Expandable title="properties"><ResponseField path="url" type="string" required={true}>
   ...
   Thumbnail Height
</ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField><ResponseField path="Upsertresponse" type="object" required={false}>
   Upsert response
<Expandable title="properties"><ResponseField path="createdRecords" type="array" required={true}>
   Created records
<Expandable title="items"><ResponseField path="createdRecords[n]" type="string" required={true}>
   Record ID
</ResponseField></Expandable></ResponseField><ResponseField path="updatedRecords" type="array" required={true}>
   Updated records
<Expandable title="items"><ResponseField path="updatedRecords[n]" type="string" required={true}>
   Record ID
</ResponseField></Expandable></ResponseField><ResponseField path="records" type="array" required={true}>
   Records
<Expandable title="items"><ResponseField path="records[n]" type="object" required={true}>
   Record
<Expandable title="properties"><ResponseField path="id" type="string" required={true}>
...
<Expandable title="properties"><ResponseField path="url" type="string" required={true}>
   ...
   Thumbnail Height
</ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField></Expandable></ResponseField>