...
<Expandable title="properties" defaultOpen={true}><ParamField path="records" type="array" required={true}>
   Records to update/upsert
<Expandable title="items" defaultOpen={false}><ParamField path="records[n]" type="object" required={true}>
   Record
<Expandable title="properties" defaultOpen={false}><ParamField path="fields" type="object" required={true}>
   Fields
...
<Expandable title="properties" defaultOpen={false}><ParamField path="url" type="string" required={true}>
   ...
   Perform upsert
<Expandable title="properties" defaultOpen={false}><ParamField path="fieldsToMergeOn" type="array" required={true}>
   Fields to merge on
<Expandable title="items" defaultOpen={false}><ParamField path="fieldsToMergeOn[n]" type="string" required={true}>
   Field name
...
*Please note that this object is one of the following possible types*
<Expandable title="possible types for response" defaultOpen={false}><ResponseField path="Updateresponse" type="object" required={false}>
   Update response
...
<Expandable title="properties" defaultOpen={false}><ResponseField path="url" type="string" required={true}>
   ...
   Upsert response
<Expandable title="properties" defaultOpen={false}><ResponseField path="createdRecords" type="array" required={true}>
   Created records
<Expandable title="items" defaultOpen={false}><ResponseField path="createdRecords[n]" type="string" required={true}>
   Record ID
</ResponseField></Expandable></ResponseField><ResponseField path="updatedRecords" type="array" required={true}>
   Updated records
<Expandable title="items" defaultOpen={false}><ResponseField path="updatedRecords[n]" type="string" required={true}>
   Record ID
