...
<Expandable title="properties"><ParamField path="url" type="string" required={true}>
   ...
   Thumbnail Height
</ParamField></Expandable></ParamField></Expandable></ParamField></Expandable></ParamField></Expandable></ParamField></Expandable></ParamField></Expandable></ParamField><ParamField path="baseId" type="string" required={true}>
   The ID of the base
