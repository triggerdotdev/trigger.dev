...
<Note>
  Need to work with larger payloads? Check out our [guide on handling large
  payloads](/guides/handling-large-payloads) which shows you how to use compression or upload to
  your own storage to work around these limits.
</Note>
