...
Generates text completions as per given prompt. [Official OpenAI Docs](https://platform.openai.com/docs/api-reference/chat/object)
...
In this job we'll create a task that generates a random joke using OpenAI GPT 3.5 .
