...
To get started with our OpenAI integration, you need to install the `@trigger.dev/openai` packages. You can do this using `npm`, `pnpm`, or `yarn`:
...
OpenAI supports API keys. Official documentation [here](https://platform.openai.com/account/api-keys).
