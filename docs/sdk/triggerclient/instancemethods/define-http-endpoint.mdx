...
An [HTTP endpoint](/documentation/concepts/http-endpoints) allows you to create a [HTTP Trigger](/documentation/concepts/triggers/http), which means you can trigger your Jobs from any webhooks.
