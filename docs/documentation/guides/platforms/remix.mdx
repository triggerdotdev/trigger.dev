...
You can write Jobs in your Remix codebase and deploy to both serverless platforms and long-running servers.
...
View our [Remix quick start guide](/documentation/quickstarts/remix) to get setup.
