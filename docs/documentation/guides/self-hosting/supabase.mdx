...
When running on a single server, our app can be trusted to manage its own connections. It knows how many connections are open and can process its internal queue as needed.
