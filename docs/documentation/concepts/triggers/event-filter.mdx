...
### Examples of string filters being used in a Trigger.
...
#### Examples of boolean filters being used in a Trigger.
...
client.defineJob({
  ...
  trigger: eventTrigger({
    ...
    schema: z.object({
      ...
      email: z.string(),
      paidPlan: z.boolean(),
      isAdmin: z.boolean(), // New field indicating admin status
    }),
    filter: {
      paidPlan: [true],
...
#### Examples of number filters being used in a Trigger.
...
#### Examples of existence filters being used in a Trigger.
...
#### Examples of combining filters being used in a Trigger.
