...
Proxies can be used with your browser via the proxy query string parameter. By default, the proxy used is a shared datacenter IP.
But you can bring you own proxy into [the console](https://console.lightpanda.io/proxies)
