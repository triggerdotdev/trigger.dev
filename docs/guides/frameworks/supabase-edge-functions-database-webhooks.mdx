...
description: "This guide will show you how to trigger a task using Supabase database webhooks."
---
...
Then, check your [cloud.trigger.dev](http://cloud.trigger.dev) project run table and you should see a succesful `hello-world` task which has been triggered when you added a new row with the `name` `Sarah Connor` to your `skynet` table.
