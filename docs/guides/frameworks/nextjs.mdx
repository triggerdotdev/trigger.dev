...
<Tabs>
  ...
  <Tab title="App Router">
      ...
      1. Add a Route Handler by creating a `route.ts` (or `route.js`) file in the `app/api` directory like this: `app/api/hello-world/route.ts`.
...
NOTE: Add your trigger secret key in Vercel (or other hosting provider).
