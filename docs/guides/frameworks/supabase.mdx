...
Then, in Supabase, navigate to your settings page in the dashboard, click 'Edge functions' in the configurations menu, and then click the 'Add new secret' button and your `TRIGGER_SECRET_KEY` with the pasted value of your Trigger.dev `prod` secret key.
