...
<Note>
If you are using Deno, to install Trigger.dev you must add a `tsconfig.json` file with these settings to the root directory:
<Accordion title="tsconfig.json example file">
```json tsconfig.json
{
  "compilerOptions": {
    "allowJs": true,
