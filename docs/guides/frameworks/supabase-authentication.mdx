...
DATABASE_URL=postgresql://postgres.creds@aws-0-region.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=1
DATABASE_URL_UNPOOLED=postgresql://postgres.creds@aws-0-region.pooler.supabase.com:5432/postgres
```
