...
<Steps>
    ...
    ![Create a project page](/images/creating-a-project/creating-a-project-1.png)
    </Step>
    <Step title="Name your project">
    ![Name your project](/images/creating-a-project/creating-a-project-2.png)
    </Step>
    ...
    ![Useful project settings](/images/creating-a-project/creating-a-project-3.png)
    </Step>
</Steps>
