...
<Note>
  Trigger.dev v3 is currently in Developer Preview. Features and improvements are added each week.
</Note>
...
<CardGroup>
  ...
  <Card title="Writing tasks" icon="wand-magic-sparkles" href="/v3/writing-tasks-overview">
