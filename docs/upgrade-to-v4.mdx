...
```bash npm
npm add @trigger.dev/sdk@latest -E
```

```bash yarn
yarn add @trigger.dev/sdk@latest -E
```

```bash pnpm
pnpm add @trigger.dev/sdk@latest -E
```
...
You'll also need to use the `latest` version of the `trigger.dev` CLI package:
