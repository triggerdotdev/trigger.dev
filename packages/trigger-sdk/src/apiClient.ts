...
export class ApiClient {
  ...
  async getEvent(eventId: string) {
    ...
    return await zodfetch(GetEventSchema, `${this.#apiUrl}/api/v3/events/${eventId}`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${apiKey}`,
      },
  ...
  async getRun(runId: string, options?: GetRunOptionsWithTaskDetails) {
    ...
    return await zodfetch(
      GetRunSchema,
      urlWithSearchParams(`${this.#apiUrl}/api/v3/runs/${runId}`, options),
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${apiKey}`,
  ...
  async getRunStatuses(runId: string) {
    ...
    return await zodfetch(GetRunStatusesSchema, `${this.#apiUrl}/api/v3/runs/${runId}/statuses`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${apiKey}`,
      },
