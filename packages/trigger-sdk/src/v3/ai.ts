...
async function performEndAndContinue(options?: { externalDeploymentId?: string }): Promise<void> {
 ...
 * answer, and signalling the client would make it re-trigger a turn it has.
 */
