...
const DEFAULT_RETURNED_ROWS = 100;
const MAX_SELECT_RETURNED_ROWS = 50000;
const MAX_SELECT_RETENTION_LIMIT = 100000;
const MAX_SELECT_HEATMAPS_LIMIT = 1000000;
const MAX_SELECT_COHORT_CALCULATION_LIMIT = 1000000000;
const MAX_BYTES_BEFORE_EXTERNAL_GROUP_BY = 22 * 1024 * 1024 * 1024;
const CSV_EXPORT_LIMIT = 300000;
const CSV_EXPORT_BREAKDOWN_LIMIT_INITIAL = 512;
const CSV_EXPORT_BREAKDOWN_LIMIT_LOW = 64;
