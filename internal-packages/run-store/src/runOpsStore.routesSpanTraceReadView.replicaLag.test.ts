// Lagging-replica coverage for the SPAN-DETAIL / TRACE route read views on the run-ops
// split. Three run lookups back two GET routes; NONE is a read-your-writes mutation gate — every one
...
describe("run-ops split — span-detail / trace route read views vs. a lagging replica", () => {
