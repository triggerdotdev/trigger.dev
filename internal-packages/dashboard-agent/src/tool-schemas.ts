...
- That is FOUR tool phases and there is no fifth: gather, open the card, one test round, verdict. The ceiling is hard: nothing outside those four phases is affordable. Resolve out-of-scope subjects in gather (list_projects/list_environments, get_*); once carded, never call them or get_current_page.
