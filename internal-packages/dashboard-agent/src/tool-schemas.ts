...
- A mandatory not-found sweep IS gather, however many rounds it takes, and doubles as the test round — its result is the finding. It never makes the card unaffordable: right after it, render the card in_progress, then the verdict — still two renders.
